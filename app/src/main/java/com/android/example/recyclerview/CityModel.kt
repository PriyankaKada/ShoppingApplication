...
class CityModel:ViewModel() {
    ...
    private fun loadData():List<City> {
        val city1 = City(R.drawable.paris_list,R.drawable.paris_detail,"Paris",30,"30 millions","La Tour Eiffel","Paris est la ville capitale et la plus grande de France. elle est située sur la Seine, dans le nord de la " +
        ...
        val city2 = City(R.drawable.london_list,R.drawable.london_detail,"Londres",70,"20 millions","Big Ben","Londres est connue pour être l’une des plus belle ville du monde, mais aussi l’une des plus diversifiée en\n" +
        ...
        val city3 = City(R.drawable.barcelona_list,R.drawable.barcelone_detail,"Barcelone",30,"15 millions","Plaça Catalunya","Barcelone compte aujourd'hui 1,7 million d'habitants, ce qui en fait la deuxième ville d'Espagne, après\n" +
        ...
        val city4 = City(R.drawable.istanbul_list,R.drawable.istanbul_detail,"Istanbul",50,"10 millions",">La Mosquée Bleue","Sur un promontoire dominant la rive européenne du détroit du Bosphore, contrôlant ainsi le passage vers " +
        ...
        val city5 = City(R.drawable.roma_list,R.drawable.rome_detail,"Rome",60,"8 millions","Fontaine de Trevi","Paris est la ville capitale et la plus grande de France. elle est située sur la Seine, dans le nord de la " +
                "France, au cœur de l’Île-de-France. Elle dispose de 2 millions d’habitants et est la cinquième des villes " +
                "les plus peuplées du monde. La ville est une des centres les plus influentes dans le monde entier, ainsi que " +
                "culturel, politique et économique très forte à la fois près at et près national. La ville est administrée " +
                "par un maire. Entouré d’un conseil municipal, il décide du budjet de la ville, des impots locaux, des grands " +
